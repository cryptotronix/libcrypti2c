...
static void test_hmac(void)
{
    ...
    ck_assert_int_eq(yacl_get_random(key, sizeof(key)), sizeof(key));
    ck_assert_int_eq(yacl_get_random(challenge, sizeof(challenge)), sizeof(challenge));
...
static void test_hmac_key_slot(void)
{
    ...
    yacl_get_random(challenge, sizeof(challenge));
...
static void t_hmac_vectors(void)
{
...
/* static void t_hkdf_extract(void) */
/* { */
...
int main(int argc, char *argv[])
{
    ...
    g_test_add_func("/hmac/test_hmac_key_slot", test_hmac_key_slot);
    g_test_add_func("/hmac/t_hmac_vectors", t_hmac_vectors);
