...
START_TEST(t_hkdf_extract)
{
    ...
    uint8_t prk_kat[] = {0x07, 0x77, 0x09, 0x36, 0x2c, 0x2e, 0x32, 0xdf, 0x0d, 0xdc, 0x3f, 0x0d, 0xc4, 0x7b, 0xba, 0x63, 0x90, 0xb6, 0xc7, 0x3b, 0xb5, 0x0f, 0x9c, 0x31, 0x22, 0xec, 0x84, 0x4a, 0xd7, 0xc2, 0xb3, 0xe5 };
    ...
    rc = hkdf_256_extract((const uint8_t *) hkdfhashes[testno].saltarray,
    ...
    lca_print_hex_string("prk:", prk, LCA_SHA256_DLEN);
    printf("prk kat: %s", hkdfhashes[testno].prkarray);

    ck_assert (0 == memcmp (prk, hkdfhashes[testno].prkarray, LCA_SHA256_DLEN));
